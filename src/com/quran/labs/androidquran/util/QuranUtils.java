...
public class QuranUtils {
	...
	public static Typeface getFontFromSD(Context context, String filename){
		String location = getQuranDirectory();
		if (location == null) return null;
		return /*Typeface.createFromFile(location + File.separator + filename)*/Typeface.createFromAsset(context.getAssets(), "fonts/"+filename);//decodeFile(location + File.separator + filename);
	}
